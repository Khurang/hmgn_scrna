...
```{r}
bld_merge= readRDS(here("march", "objects", "script3-bld_merge_incsinglrlabels_allcelltypes.rdss"))
```
...
here::here()
pdf(here("march", "plots","findmarkers", paste0("findmarkerplots_bld_", cluster, ".pdf")), height= 20, width=20)
for(i in 2:4)

{
 ...
 write.csv(markers, here("march", "plots","findmarkers",  paste0(currentgenotype, "vs_bld_wt.csv")), row.names = TRUE)
  }
, error = function(e) {
    print(paste("Error occurred:", e))
    return(NULL)
...
here::here()
pdf(here("march", "plots","findmarkers","subset_excwtb", paste0("findmarkerplots_exc_wtb_bld_", cluster, ".pdf")), height= 20, width=20)
for(i in 2:4)

{
 ...
 write.csv(markers, here("march", "plots","findmarkers", "subset_excwtb", paste0(currentgenotype, "vs_bld_wt_excwtb.csv")), row.names = TRUE)
  }
, error = function(e) {
    print(paste("Error occurred:", e))
    return(NULL)
